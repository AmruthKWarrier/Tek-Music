      ...
      <div style={{ display: "block" }}>
        <div className="bgslider2">
          <div className="justify-content-md-center maincontent2">
            <font style={{ color: "gold" }}>Classical Wing</font>
          </div>
          <div className="justify-content-md-center maincontent2">
          ...
          <Row xs={1} md={2} className="g-4">
              ...
              >
                <Card.Body>
                  ...
                  <Card.Text>
                    ...
                    <div className="maincontent3">
                      <font>Vishal +91 6360 530 676</font>
                    </div>
                    <div className="maincontent3">
                      <font>Rethika +91 97901 96953</font>
                    </div>
                  </Card.Text>
                  <a
                    href="https://forms.gle/q7boLSBaqfGKkvu37"
                    target="__blank"
                    className="fontjoin"
                  >
            ...
            <Col>
              ...
              >
                <Card.Body>
                  <Card.Title>
                    <div className="maincontent3t">Percussion</div>
                  </Card.Title>
                  <Card.Text>
                    <div className="maincontent3">
                      <font>For queries, Contact: </font>
                  ...
                  <a
                    href="https://forms.gle/QmEmwq7jFsvpCUPA9"
                    target="__blank"
                    className="fontjoin"
                  >
                    <button className="button text-bt-2">
          ...
          <Row xs={1} md={2} className="g-4">
              ...
              >
                <Card.Body>
                  ...
                  <Card.Text>
                    ...
                    <div className="maincontent3">
                      <font>Vishal +91 63605 30676</font>
                    </div>
                  </Card.Text>
                  <a
            ...
            <Col>
              ...
              >
                <Card.Body>
                  <Card.Title>
                    <div className="maincontent3t">Veena</div>
                  </Card.Title>
                  <Card.Text>
                    <div className="maincontent3">
                      <font>For queries, Contact: </font>
                  ...
                  <a
                    href="https://forms.gle/DqV1wWzvzfP9w9Vh9"
                    target="__blank"
                    className="fontjoin"
                  >
                    <button className="button text-bt-2">
